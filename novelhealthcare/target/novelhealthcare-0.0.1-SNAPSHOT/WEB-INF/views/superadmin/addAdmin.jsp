				                            	...
				                            	<div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:select class="form-control" path="hospitalName" data-val="true" data-val-number="The field Hospital must be a number." id="User_HospitalId" style="">
				                                ...
				                                <div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="firstName" type="text" data-val="true" data-val-required="The First Name field is required." id="User_FirstName" maxlength="50" value=""></form:input>
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="middleName" type="text" data-val="true" data-val-required="The Middle Name field is required." id="User_MiddleName" maxlength="50" value=""></form:input>
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="lastName" type="text" data-val="true" data-val-required="The Last Name field is required." id="User_LastName" maxlength="50" value=""></form:input>
				                                ...
				                                <div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="phone" type="text" data-val="true" data-val-required="The Last Name field is required." id="User_LastName" maxlength="50" value=""></form:input>
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="email" type="text" data-val="true" data-val-required="The Last Name field is required." id="User_LastName" maxlength="50" value=""></form:input>
